			...
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					<div class="navbar-header page-scroll">
						...
						@if(isset($user))
            			<p style="color:white">Welcome User {{$user}}</p>
           			 	@endif
					</div> 
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="page-scroll scroll" href="#home">Home2</a></li>
							<li><a class="page-scroll scroll" href="#home">Home3</a></li>
							<li><a class="page-scroll scroll" href="#home">Home4</a></li>
